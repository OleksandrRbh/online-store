    ...
    return `
      <div class="card">
        <div class="card__content">
          <img src="${this.productData.images[0]}" class="card__image">
          ...
          <div class="card__info">
            <div class="info-header">
              ...
              <span class="info-price">${this.productData.price}</span>
            </div>

            <div class="info-title">${this.productData.title}</div>

            <div class="info-category">${this.productData.category}</div>
          </div>
        </div>
